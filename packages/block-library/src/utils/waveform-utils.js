...
// SVG paths for the playlist control icons (24x24 viewBox). These mirror the
// official @wordpress/icons previous, next, shuffle, and loop icons so they
// match the rest of the product (this file builds DOM directly for the
// frontend Interactivity API, so it can't import the React icon components).
const ICON_PREV =
	'M11.6 7l-1.1-1L5 12l5.5 6 1.1-1L7 12l4.6-5zm6 0l-1.1-1-5.5 6 5.5 6 1.1-1-4.6-5 4.6-5z';
const ICON_NEXT =
	'M6.6 6L5.4 7l4.5 5-4.5 5 1.1 1 5.5-6-5.4-6zm6 0l-1.1 1 4.5 5-4.5 5 1.1 1 5.5-6-5.5-6z';
const ICON_SHUFFLE =
